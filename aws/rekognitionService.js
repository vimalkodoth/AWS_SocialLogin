module.exports = (function($,window){
    ...
    var socialMediaService = require('./../socialLogin/socialMediaLogin.js') // Not included for now;
    var that, config, globalConfig;
    function RekognitionService(params){
        that = this;
        globalConfig = AWSService.getAWSRequestConfig();
        config = params || {};
        this.rekognition = new AWS.Rekognition({credentials: globalConfig.credentials, region:'eu-west-X', correctClockSkew: true });
